...
public class ClinicServiceImpl implements ClinicService {
    ...
    public void saveOwner(Owner owner, @ParameterValueKeyProvider Integer id) throws DataAccessException {
    ...
    @Transactional(readOnly = true, timeout = 60)
    @ReadThroughSingleCache( namespace="Owner" , expiration = 300)
    public Owner findOwnerById(@ParameterValueKeyProvider Integer id) throws DataAccessException {
